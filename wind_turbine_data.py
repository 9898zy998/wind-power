...
class WindTurbineData(Dataset):
    ...
    def __read_data__(self):
        self.df_raw = pd.read_csv(os.path.join(self.data_path, self.filename))#read csv
        self.df_raw = self.df_raw.fillna(method='bfill')#backward fill
        #modify abnormal values
        self.df_raw[self.df_raw['Pab1']>89]=89
        self.df_raw[self.df_raw['Pab2']>89]=89
        self.df_raw[self.df_raw['Pab3']>89]=89
        self.df_raw[self.df_raw['Patv']<0]=0
